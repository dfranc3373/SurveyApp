...
if(!isset($_POST['email'])) {
	...
	exit();
		...
		if($sth->rowCount() == 0) {
			...
			$info_string = array("name" => $_POST["name"], "email" => $_POST["email"], "password" => $_POST["password"], "facebook" => (isset($_POST["FB"]) ? 1 : 0), "gender" => $_POST["gender"], "age_range" => $_POST["age_range"], "token" => $token);
