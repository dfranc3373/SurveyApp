...
if($sth->rowCount() == 0) {
	...
	$c->execute(array("CompanyID" => $survey->Company));
	...
	$arr = array("SurveyID" => $survey->SurveyID, "Name" => $survey->Name, "Company" => $company->Name, "DateCreated" => strtotime($survey->DateCreated), "AgeRange" => $survey->AgeRange, "GenderType" => $survey->GenderType, "Coupon" => $coupon, "Questions" => $questions);
